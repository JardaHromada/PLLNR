...
Widget build(BuildContext context) {
  ...
  return Container(
    ...
    child: Row(
      ...
      children: [
        Text(
          'Přihlášen jako: ${user.email!} idk asi funguje',
  ...
  Widget _buildSettingItem(IconData icon, String title) {
    return Container(
      ...
      child: Row(
        children: [
          Icon(icon, color: Color(0xFFD7E2FF)),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _buildBottomBarButton(context, 'nastavení', Icons.settings, '/settings', isSpecial: true),
        ],
      ),
    );
  }
